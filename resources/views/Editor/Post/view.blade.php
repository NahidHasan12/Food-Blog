                        ...
                        <div class="col">
                            <table class="table table-sm table-hover table-bordered" style="color: black">
                                ...
                                <tr>
                                    <th>Action</th>
                                    <td class="mt-1">
                                        <a title="Edit Post" style="height:28px; padding-top:5px; background: #060e64; color:white; font-weight: bold;" href="{{ route('post.edit',$post->id) }}" class="btn btn-sm"><i class="mdi mdi-pencil"></i></a>
                                    </td>
                                </tr>
                            </table>
                        </div>
